...
fog_color:add_callback(function()
	...
	entity.set_prop(c_fog_controller.entity, "m_fog.colorPrimary", color32)
	entity.set_prop(entity.get_local_player(), "m_skybox3d.fog.colorPrimary", color32)
end)
--endregion
...
client.set_event_callback("paint", function()
	entity.set_prop(c_fog_controller.entity, "m_fog.enable", enable_fog() and 1 or 0)
	entity.set_prop(entity.get_local_player(), "m_skybox3d.fog.enable", enable_fog() and 1 or 0)
